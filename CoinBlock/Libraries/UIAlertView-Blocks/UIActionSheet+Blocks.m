...
- (void)willPresentActionSheet:(UIActionSheet *)actionSheet {
    ...
    for (UIView *subview in actionSheet.subviews) {
        if ([subview isKindOfClass:[UIButton class]]) {
            ...
            //button.titleLabel.textColor = kViewColorBlueText;
            //[button setTitleColor:kViewColorBlueText  forState:UIControlStateNormal];
            //[button setTitleColor:kViewColorBlueText  forState:UIControlStateHighlighted];
            //[button setTitleColor:kViewColorBlueText  forState:UIControlStateSelected];
            //button.titleLabel.minimumFontSize = 10;
            
            //smaller font
            if(button.titleLabel.text.length > 25)
