...
//wrapper
#define kAlertButtonGreen SIAlertViewButtonTypeDestructive
#define kAlertButtonOrange SIAlertViewButtonTypeCancel
#define kAlertButtonGray SIAlertViewButtonTypeDefault
...
@property (nonatomic, copy) SIAlertViewHandler didCloseHandler;

@property (nonatomic, readonly, getter = isVisible) BOOL visible;
@property (nonatomic) BOOL continueMode;
@property (nonatomic) BOOL pauseMenuMode;
@property (nonatomic) BOOL flashMode;
@property (nonatomic) BOOL soundMode;
@property (nonatomic) CGFloat forcedHeight;

@property (strong, nonatomic) SIAlertViewController *viewController;
@property (nonatomic, strong) UIImageView *oldmanImageView;
@property (nonatomic, strong) UIButton *oldmanButton;
...
@property (nonatomic, strong) UIColor *destructiveButtonColor2 NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR;
